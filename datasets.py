...
datasets: Dict[str, Dataset] = {
    '100k': Dataset(path="data/100k/ratings.csv", sep=",", name="100k", items_path="data/100k/movies.csv", 
                    items_sep=",", skip_rows=1),
    '1m': Dataset(path="data/1m/ratings.dat", sep="::", name="1m", items_path="data/1m/movies.dat", items_sep="::"),
    '10m': Dataset(path="../datasets/10m/ratings.dat", sep="::", name="10m", items_path="../datasets/10m/movies.dat", items_sep="::"),
